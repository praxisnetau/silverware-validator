...
/**
 * An extension of the rule class for an email rule.
 *
 * @package SilverWare\Validator\Rules
 * @author Colin Tucker <colin@praxis.net.au>
 * @copyright 2017 Praxis Interactive
...
class EmailRule extends Rule
{
     ...
     * @config
     */
    private static $default_type = 'email';
    ...
    {
        return $value ? (boolean) filter_var($value, FILTER_VALIDATE_EMAIL) : true;
    }
    ...
    {
        return _t(__CLASS__ . '.DEFAULTMESSAGE', 'This value should be an email address.');
    }
}
