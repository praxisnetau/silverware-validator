...
/**
 * An extension of the max rule class for a maxlength rule.
 *
 * @package SilverWare\Validator\Rules
 * @author Colin Tucker <colin@praxis.net.au>
 * @copyright 2017 Praxis Interactive
 ...
 * @link https://github.com/praxisnetau/silverware-validator
 */
class MaxLengthRule extends MaxRule
{
    /**
     ...
     * @config
     */
    private static $default_type = 'maxlength';
    ...
    public function getDefaultMessage()
    {
        return sprintf(
            _t(
                ...
                'This value should have %d characters or less.'
            ),
            $this->max
        );
    }
